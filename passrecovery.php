    ...
    <div class="container" style="margin-top: 1.5rem; margin-bottom:11em;">
        ...
        <div class="row">
            ...
            <div class="col-xl-8 offset-xl-2 py-5" style="background-color: #ECE5E4;">
                ...
                <h1 class="text-center">¿Has olvidado tu contraseña?</h1>
                <h1 class="text-center">RECUPERALA AQUÍ
                </h1>                
                    ...
                    <div class="controls">
                        ...
                        <div class="row" style="margin-left: 2em;">
                            <div class="form-group">
                                <label for="form_email">Introduce tu dirección de correo electrónico con la que te registraste en REPOMICH *</label>
                                ...
                                <label for="form_email" style="font-size: 14px; color: red;">IMPORTANTE: Si tu correo no es correcto, se recargara la página actual.*</label>
                        ...
                        <div class="row">
                           <div class="col-md-12" style="display: flex; justify-content:center;">
                            <input type="submit" class="btn btn-success btn-send" value="Enviar" style="background-color: #1B396A; font-size:24px; border: none;" onclick="checkIfEmpty()">
                        </div>
                        <div class="col-md-12">
                            <p class="text-muted">
                            </div>
