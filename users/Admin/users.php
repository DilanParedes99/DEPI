...
<script>
    ...
    <div class="container container_mine" style="margin-bottom: 200px;">
        <center><h2>Gestión de usuarios</h2></center><br><br>   
        <div class="table-responsive">
            <table class="table">
                ...
                <?php
                    include "../../includes/dbconnection.php";
                    $sql = "SELECT nombre,apellidos,correo,telefono,idIns,area FROM usuario;";
   ...
   <script>
       ...
       function del(){
            window.location.href = "./dropUser.php?id=" + ids;
       }
   </script>
