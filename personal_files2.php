...
<body>
	...
	<div class="container cont">	
		<div class="row mt-5 mb-xl-1 text-center"> <!-- The row for the title of the page. At an xl size, has a margin-bottom of 5 -->
			<div class="col">
				<h2 class="text-center mb-3"><br>Bienvenido al panel de administración de los archivos del REPOMICH</h2>	
				<br>			
			</div>
		</div> 
				...
				<div class="row">
					<div class="col-sm-4 col-12 mt-3"> <!-- Has an offset at an xl size of 2, md of 1, so that the ipad pro would look fine. -->
						<span style="font-size: 25px;">
							<a href="showallthesisAdmin.php" style="color:#ac2144;"><i class="fas fa-book" style="font-size: 15vmin;"></i><br><br><p style="color: #3d3d3d; font-weight: bold;">Tesis</p></a>
						</span>					
					</div>
					<div class="col-sm-4 col-12 mt-3">
						<span style="font-size: 25px;">
							<a href="./articleadmonresultsAdmin.php" style="color:#ac2144;"><i class="fas fa-file" style="font-size: 15vmin;"></i><br><br><p style="color: #3d3d3d; font-weight: bold;" class="">Artículos</p></a>
						</span>				
					</div>
					<div class="col-sm-4 col-12 mt-3 mb-5">
						<span style="font-size: 25px;">
							<a href="showallprojectsAdmin.php" style="color:#ac2144;"><i class="fas fa-tasks" style="font-size: 15vmin;"></i><br><br><p style="color: #3d3d3d; font-weight: bold;" class="offset-xl-1">Proyectos</p></a>
						</span>					
					</div>
				</div>
			</div>			
